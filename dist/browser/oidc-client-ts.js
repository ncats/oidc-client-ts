...
var oidc = (() => {
  ...
  async function DPoP(keypair, htu, htm, nonce, accessToken, additional) {
    ...
    if (additional !== void 0 && (typeof additional !== "object" || typeof additional === null || Array.isArray(additional))) {
  ...
  async function publicJwk(key) {
    const { kty, e: e2, n: n2, x, y, crv } = await crypto.subtle.exportKey("jwk", key);
    return { kty, crv, e: e2, n: n2, x, y };
  }
  ...
  var buildDPoPHeader = async (url, method, token) => {
    ...
    DpopKeypair.publicKey = keypair.publicKey;
    DpopKeypair.privateKey = keypair.privateKey;
    return dpop;
  };
  var TokenClient = class {
    ...
    async exchangeCode({
      ...
      const dpopHeader = this._settings.enable_dpop ? await buildDPoPHeader(url, "POST", void 0) : void 0;
